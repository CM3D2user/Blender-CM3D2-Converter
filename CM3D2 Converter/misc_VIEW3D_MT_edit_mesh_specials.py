...
class selected_mesh_vertex_group_blur(bpy.types.Operator):
	...
	selection_blur_range_multi = bpy.props.FloatProperty(name="選択をぼかす範囲倍率", default=4.0, min=0.0, max=100.0, soft_min=0.0, soft_max=100.0, step=10, precision=2)
	selection_blur_accuracy = bpy.props.IntProperty(name="選択をぼかす分割精度", default=4, min=1, max=10, soft_min=1, soft_max=10)
	
	blur_range_multi = bpy.props.FloatProperty(name="ウェイトをぼかす範囲倍率", default=2.0, min=0.0, max=100.0, soft_min=0.0, soft_max=100.0, step=10, precision=2)
